...
### As a guest, I want to see on the Homepage a highlighted slider
#### Acceptance criteria:
...
### As a guest, I can use the search bar to look for website content
#### Acceptance criteria:
...
### As a guest, I want to subscribe to the page to receive notifications about the website:
#### Acceptance criteria:
...
### As a guest, I want to be able to log in to see my account
...
##### Steps to reproduce:
       ...
       Insert registered email address: test@test.io
       Insert password: sfdgfhgjklj;koilukytredgfchgvhbhjiu8976iytghbjnm,
...
### As a guest, I want to buy a book without a login
#### Acceptance criteria :
...
### As a guest, I can input a discount coupon
#### Acceptance Criteria
